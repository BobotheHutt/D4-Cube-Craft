...
registerUniques("warlock", [
    ...
    { name: "Eye of Baal", slot: "weapon", boss: "Bartuc", power: "Soul Shard Skills and their demons deal x [60 - 80%] damage. Casting a Soul Shard Skill increases all your damage by x10% for 15 seconds, up to x50%." },
    { name: "Hecaton Chasm", slot: "weapon", boss: "Astaroth", power: "Tyrant's Grasp deals x [100 - 120%] increased damage and summons 5 additional demonic hands in all directions." },
    { name: "Infernal Homunculus", slot: "weapon", boss: "Urivar", power: "Your Archfiend Skills deal x[50 - 70%] increased damage and gain their Lesser Demon Side Upgrades for free with 200% longer durations." },
    { name: "Litany of Sable", slot: "weapon", boss: "Astaroth", power: "Dread Claws deals x [100 - 120%] increased damage and additional claws fire out when you gain a stack of Shadowform." },
    { name: "Rictus of Terror", slot: "weapon", boss: "Duriel", power: "Laalish deals x [100 - 120%] increased damage. Command Laalish's Terror Realm is an Ultimate Skill that lasts 100% longer and while active your Abyss Skills Execute enemies." },
    { name: "Scepter of the Three", slot: "weapon", boss: "Andariel", power: "You can now equip all Ultimate Skills and gain 15 Ranks in them. Attacking enemies with no active Ultimate Skill builds up your Ultimate Skill damage by x [4 - 5%], up to x [80 - 100%]. After starting Ultimate Skills the damage bonus is reset once all have ended." },
    { name: "Scourge of Duriel", slot: "weapon", boss: "Duriel", power: "Umbral Chains gains the Epicenter Variant for free and deals x [60 - 80%] increased damage." },
    { name: "Sire of Sin", slot: "weapon", boss: "Grigoire", power: "Infernal Breath gains the Explosive Death Variant for free and deals x [20 - 30%] increased damage." },
    ...
    // ── PANTS ───────────────────────────────────────────
    { name: "Kabraxis' Will", slot: "pants", boss: "Beast in the Ice", power: "Wall of Agony gains the Fallen Army Variant for free and deals x[20 - 30%] increased damage." },
    { name: "Sashes of the Wretched", slot: "pants", boss: "Bartuc", power: "Summon a Tortured Wretch when your Current Life drops below 55% of your Maximum Life. Enemies Taunted by Tortured Wretch take x [8 - 10%] increased damage from you for 5 seconds." },
    // ── BOOTS ───────────────────────────────────────────
    { name: "Footfalls of the Waning World", slot: "boots", boss: "Astaroth", power: "Your Evade is now Nether Step and your Evade Cooldown is reduced by [0.6 - 1] seconds as you lose or consume Shadowform stacks." },
    ...
    // ── RINGS ───────────────────────────────────────────
    { name: "Hellbrand Signet", slots: ["ring-left", "ring-right"], boss: "Butcher", power: "Sigil of Chaos gains the Diabolic Rebuke Variant for free and deals x [50 - 70%] increased damage." },
    { name: "Seal of the Ophanim", slots: ["ring-left", "ring-right"], boss: "Varshan", power: "Profane Sentinel deals [230 - 270]% increased damage and summons an additional eye that follows you for 10 seconds." },
    { name: "The Fecund Seal", slots: ["ring-left", "ring-right"], boss: "Harbinger", power: "Sigil of Summons deals x [100 - 140%] increased damage and you can summon up to 3 additional demon swarmers with kills outside the ritual." },
]);
