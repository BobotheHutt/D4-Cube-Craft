...
registerUniques("druid", [
    ...
    { name: "Gathlen's Birthright", slot: "helm", boss: "Zir", power: "Cyclone Armor is automatically triggered once every [5 - 8] seconds.  This effect does not incur the Cooldown." },
    { name: "Ifeh's Dire Totem", slot: "helm", boss: "Harbinger", power: "Grizzly Rage is now a Werewolf Skill and Shapeshifts you into a Dire Werewolf. Dire Werewolves gain [100 - 125%] Critical Strike Damage, [100 - 125%] bonus Poisoning damage and Spirit Cost Reduction instead of Armor. In addition, kills Heal you for 5% of your Maximum Life." },
    ...
    // ── CHEST ───────────────────────────────────────────
    { name: "Insatiable Fury", slot: "chest", boss: "Andariel", power: "For 2 seconds after Casting Trample, you may Cast Trample again without incurring the Cooldown. Trample additionally deals [150 - 200%] bonus damage." },
    { name: "Mad Wolf's Glee", slot: "chest", boss: "Astaroth", power: "Lacerate has no Cooldown, costs 100 Spirit to cast and deals [80 - 100%] bonus damage but no longer grants Immunity. Lacerate is also a Core Skill." },
    { name: "Might of the Ursine", slot: "chest", boss: "Harbinger", power: "Gain [10 - 13%] bonus damage for each stack of Resolve while in Werebear form. Additionally, you automatiicaly gain 1 stack of Resolve every 1 seconds while in Werebear form" },
    // ── GLOVES ──────────────────────────────────────────
    { name: "Dark Howl", slot: "gloves", boss: "Urivar", power: "Debilitating Roar is now a Werewolf Skill.  In addition, Debilitating Roar increases your damage by [60 - 80]%[x] while in Werewolf form for the duration." },
    { name: "Heart of Azgar", slot: "gloves", boss: "Butcher", power: "When you hit at least 1 enemy with Maul, increase its Attack Speed by +3% and damage by [20 - 25%] for 5 seconds, stacking up to 5 times." },
    { name: "Unsung Ascetic's Wraps", slot: "gloves", boss: "Zir", power: "Lightning Storm gains 1 additional strike each time it grows and deals [20 - 25]%[x] bonus damage." },
    // ── PANTS ───────────────────────────────────────────
    { name: "Kilt of Blackwing", slot: "pants", boss: "Urivar", power: "Ravens deal [80.0 - 100.0]%[x] increased damage and Shapeshifting into a different form or activating a Companion Skill Summons a Raven that attacks nearby enemies.  Summoning a Raven has a chance to call forth an Unkindness for 10 seconds, increasing the number of Ravens Summoned to 3 for he duration." },
    { name: "Storm's Companion", slot: "pants", boss: "Andariel", power: "Your Wolf Companions are infused with the power of the storm, dealing [80 - 100]%[x] increased Lightning damage and gaining the Storm Howl ability." },
    // ── BOOTS ───────────────────────────────────────────
    { name: "Khamsin Steppewalkers", slot: "boots", boss: "Bartuc", power: "Gain Earthen Bulwark's Earthen Shrapnel upgrade for free and the damage is increased by [150 - 200]%[x]." },
    { name: "Wildheart Hunger", slot: "boots", boss: "Astaroth", power: "Rabies spreads 100% faster and deals x10% bonus damage each time it spreads, up to [120 - 150%]." },
    // ── AMULET ──────────────────────────────────────────
    ...
    // ── RINGS ───────────────────────────────────────────
    { name: "Airidah's Inexorable Will", slots: ["ring-left", "ring-right"], boss: "Beast in the Ice", power: "Storm Strike chains to twice as many targets and gains [7 - 10%] bonus damage." },
    { name: "Earthbreaker", slots: ["ring-left", "ring-right"], boss: "Bartuc", power: "Casts of Landslide leave behind Tectonic Spikes that deal [375 - 525] Physical damage over 2 seconds. Spawning a Landslide pillar within Tectonic Spikes has a [50 - 60]% chance to spawn two instead." },
