...
registerUniques("barbarian", [
    ...
    { name: "Chainscourged Mail", slot: "pants", boss: "Butcher", power: "Casting a damaging Brawling Skill disables it afterwards. When all of these Skills on your Action Bar are disabled, they become re-enabled with their Cooldowns refreshed. Your Brawling Skills deal [80-100]%[x] increased damage for each disabled Skill." },
    // ── BOOTS ───────────────────────────────────────────
    ...
    // ── AMULET ──────────────────────────────────────────
    { name: "Battle Trance", slot: "amulet", boss: "Astaroth", power: "Frenzy gains the Barrage Variant for free and can stack 2 additional times. While at maximum stacks, you deal [75-100]%[x] increased damage and your other Skills gain [35-45]%[+] increased Attack Speed." },
