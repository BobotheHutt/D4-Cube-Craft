...
registerUniques("general", [
    ...
    // ── HELM ────────────────────────────────────────────
    { name: "Crown of Lucion", slot: "helm", boss: "Astaroth", power: "Each time you use a Skill with a Resource Cost, gain [10 - 15]% or 18%[x] increased damage and Resource Cost is increased by 30%[+] for 4 seconds, stacking up to 5 times." },
    { name: "Godslayer Crown", slot: "helm", boss: "Andariel", power: "When you Stun, Freeze, or Immobilize an Elite, you Pull In all Nearby enemies and deal [30-40]%[x] increased damage to them." },
    // ── CHEST ───────────────────────────────────────────
    ...
    { name: "Temerity", slot: "pants", boss: "Harbinger", power: "Effects that Heal you beyond 100% Life grant you a Barrier up to [80 - 100]% of your Maximum Life that lasts for 8 seconds. You may now drink your Healing Potion while at full Life." },
    ...
    { name: "Signet of Pelghain", slots: ["ring-left", "ring-right"], boss: "Beast in the Ice", power: "Your Freeze effects cause enemies to permanently take x [15 - 20%] increased damage from you for each second they are Frozen." },
